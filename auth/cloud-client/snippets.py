...
def implicit():
    ...
    storage_client = storage.Client.from_service_account_json('/var/www/html/python/myprojectwithfirebase-8a1e4-firebase-adminsdk-bcezw-742d66b7bc.json')
...
def explicit():
    ...
    storage_client = storage.Client.from_service_account_json(
        '/var/www/html/python/myprojectwithfirebase-8a1e4-firebase-adminsdk-bcezw-742d66b7bc.json')
